# contexto
El proyecto original es Stable-diffusion y dependiendo el hardware se puede instalar de muchas formas a continuación a instalación mas sencilla solo con CPU
